...
let modulePaths = {
 ...
 "packages/playingbyflutterweb/generated_plugin_registrant": "packages/playingbyflutterweb/generated_plugin_registrant.ddc",
 "packages/playingbyflutterweb/main": "packages/playingbyflutterweb/main.ddc",
 "packages/playingbyflutterweb/main_web_entrypoint": "packages/playingbyflutterweb/main_web_entrypoint.ddc",
 "packages/playingbyflutterweb/models/item": "packages/playingbyflutterweb/models/item.ddc",
...
define("main_web_entrypoint.dart.bootstrap", ["packages/playingbyflutterweb/main_web_entrypoint", "dart_sdk"], function(app, dart_sdk) {
  ...
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "package:playingbyflutterweb/main_web_entrypoint.dart") {
          // Clear static caches.
